...
namespace ItemsLibary
{
    public class ItemsActions
    {
        ...
        public ItemsActions(int day, Items items)
        {
            Days = day;
            ItemInUse = items;
        }
        ...
        public void KillThatCat(IVillager villager)
        {
            LogEvents.Log($"{villager.Name} kills a stray cat.", Days);
        }

        public void MurderVillager(IVillager villager)
        {
            Random random = new();
